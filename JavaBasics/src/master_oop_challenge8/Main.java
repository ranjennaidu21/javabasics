...
public class Main {
	...
	public static void main(String[] args) {
		Hamburger hamburger = new Hamburger("Basic","Suasage",3.56,"White");
		hamburger.addAddition1("Tomato", 0.27);
		hamburger.addAddition2("Lettuce", 0.75);
		hamburger.addAddition3("Cheese", 1.12);
		System.out.println("Total base burger price is: " + hamburger.itemizeBurger());
		System.out.println("===================================");
		Healthy healthy = new Healthy("Mutton",2.00);
		healthy.addAddition1("Tomato", 0.27);
		healthy.addHealthyaddition1("Mayonese", 1.00);
		healthy.addHealthyaddition2("Chily", 1.50);
		System.out.println("Total Healthy burger price is: " + healthy.itemizeBurger());
		System.out.println("===================================");
		Deluxe db = new Deluxe();
		System.out.println("Total Healthy burger price is: " + db.itemizeBurger());
