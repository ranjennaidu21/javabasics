...
//Immutable class - Class that cannot be changed once they are created
//rules for Immutable class
/*
1. Don't provide "setter" methods — methods that modify fields or objects referred 
	to by fields.
...
- Don't share references to the mutable objects. Never store references to external, 
	...
	store references to the copies. Similarly, create copies of your 
